...
> 本文是业务验收口径，不是跨层契约权威。跨层契约以 `docs/decisions/0007-phase1-cross-layer-contracts.md` 和 `src/contracts/phase1.ts` 为准；技术运行基线以 `docs/decisions/0006-phase1-technical-baseline.md` 为准。

## P0 工程验收

P0 完成时，系统还不产生投资判断，也不连接真实 Binance。P0 只证明工程地基成立：
